...
| [Alpine Linux](https://alpinelinux.org) | 3.20 | ✅ | [`mptcpd`](https://pkgs.alpinelinux.org/packages?name=mptcp*) is available since v3.22. |
...
| [openEuler](https://www.openeuler.openatom.cn) | 24.09 | | [`mptcpd`](https://gitee.com/src-openeuler/mptcpd/pulls/1) 0.13 is added in 25.03. |
